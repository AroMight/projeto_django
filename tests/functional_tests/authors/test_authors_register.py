...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def form_field_test_with_callback(self, callback):
        ...
        form.find_element(By.NAME, 'email').send_keys('lol@lol.com')
    ...
    def test_passwords_do_not_match(self):
        def callback(form):
            ...
            password1.send_keys('Abc@123456')
            password2.send_keys('123456@cbA')
    ...
    def test_user_valid_data_register_sucessfully(self):
        ...
        form = self.get_form()
        self.get_by_placeholder(form, 'Ex.: John').send_keys('Leandro')
        self.get_by_placeholder(form, 'Ex: Doe').send_keys('Borges')
        self.get_by_placeholder(
            form, 'Your username').send_keys('my_username')
        self.get_by_placeholder(form, 'Your email').send_keys(
            'leandro@borges.com')
        self.get_by_placeholder(
            form, 'Type your password').send_keys('Abc@123456')
        self.get_by_placeholder(
            form, 'Repeat your password').send_keys('Abc@123456')
        form.submit()
